...
async def do_manage_settings(content: str, owner: Optional[str] = None) -> Dict:
    ...
    try:
        ...
        _SECRET_KEYS = {
            ...
            "tavily_api_key", "serper_api_key", "exa_api_key", "firecrawl_api_key", "app_public_url",
        }
        def _is_secret(k):
        ...
        _ALIASES_SET = {
            ...
            "subagent model": "subagent_model", "sub-agent model": "subagent_model",
            "sub agent model": "subagent_model",
            "subagent timeout": "subagent_timeout_seconds",
            "sub-agent timeout": "subagent_timeout_seconds",
